	...
	<div class="content-container" 	direction='vertical'>
		...
		<div>
			<el-table :data="orderList" tooltip-effect="dark" style="width: 100%;">
				<el-table-column label='类型' width='100' prop='state'></el-table-column>
				<el-table-column label='名称' width='300' prop='name'></el-table-column>
				<el-table-column label='订单号' width='200' prop='id'></el-table-column>
				<el-table-column label='店长信息' width='200' prop='manage'></el-table-column>
				<el-table-column label='件数' width='100' prop='count'></el-table-column>
